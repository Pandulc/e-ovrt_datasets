...
| 2026-08-17 | coco_val2017 | https://images.cocodataset.org/zips/val2017.zip | datasets/raw/coco_val2017/ | 807M (5000 imgs) | — | Descargado | Arnés de retención de vocabulario abierto del tier T2 de fine-tuning (ADR-017/D-FT-14); consumido por `e-ovrt_experimental-setup/finetuning/`. Gitignorado entero (.gitignore:44-50, material raw de terceros reproducible desde la fuente oficial). |
...
| 2026-06-05 | SHEL5K | Mendeley Data | datasets/raw/shel5k/9rcv8mm682-4.zip | 1.3G zip / 2.5G local | dfba1d3ce01af69d791020cdfdfdbc25904b41724d11160361e7a4cd164e7a7a | Descargado | Extraido en `datasets/raw/shel5k`; Pascal VOC con 5000 imagenes, 5000 XML, 75578 objetos. Sin split oficial detectado; usar custom_seeded. ✎ 2026-07-23: promovido a estrato de bench_v3 (5.000 imgs, doc 66) y fuente canonical_v2 (GT nativo de bare_head vía `head`). |
